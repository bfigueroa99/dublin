  ...
  const itinerary = [
    {
      ...
      mapQuery: "Clink i Lár, Dublin",
      icon: "🛬",
      tasks: [
        { id: 1, text: "Aterrizaje 20:25 (Ryanair desde Birmingham)" },
        { id: 2, text: "Tomar Aircoach 700 o Dublin Express 782 en Terminal" },
        { id: 3, text: "Bajar en O'Connell Bridge/Aston Quay" },
        { id: 4, text: "Check-in en Clink i Lár (O'Connell St)" },
        { id: 5, text: "🍔 CENA: Supermac's (abierto hasta 2 AM) - Pide 'Curry Cheese Chips'" },
    ...
    },
    {
      ...
      icon: "🏔️",
      tasks: [
        { id: 7, text: "05:30 - Desayuno rápido en Spar O'Connell St (24h)" },
        { id: 8, text: "06:30 - Salida del tour (Revisar ticket: Molly Malone o Gresham)" },
        { id: 9, text: "En ruta: Parque Nacional Killarney + Torc Waterfall" },
    ...
    },
    {
      ...
      icon: "🍺",
      tasks: [
        { id: 13, text: "11:00 - Jameson Distillery Bow St (Smithfield) - LUAS Rojo" },
        { id: 14, text: "12:30 - Almuerzo en The Brazen Head (pub de 1198, el más antiguo)" },
        { id: 15, text: "14:00 - GUINNESS STOREHOUSE (Entrada reservada)" },
        { id: 16, text: "Dentro: Ticket pinta gratis + Gravity Bar (vistas 360°)" },
        { id: 17, text: "17:00 - Caminar a TEMPLE BAR (20 min desde Guinness)" },
    ...
    },
    {
      ...
      mapQuery: "Phoenix Park",
      icon: "🦌",
      tasks: [
        { id: 20, text: "10:00 - Trinity College (entrada gratis a patios)" },
        { id: 21, text: "Opcional: Book of Kells (€16) o Chester Beatty Library (gratis)" },
        { id: 22, text: "12:30 - LUAS Rojo a Heuston Station" },
        { id: 23, text: "Alquilar bici en Phoenix Park Bikes (entrada Parkgate St)" },
        { id: 24, text: "🚴 Ruta: Cruz Papal → Ver ciervos (Fallow Deer)" },
        { id: 25, text: "Ver Áras an Uachtaráin (Casa del Presidente)" },
        { id: 26, text: "15:00 - Devolver bici y volver al centro" },
        { id: 27, text: "17:00 - Paseo por Grafton Street (músicos callejeros)" }
      ],
    ...
    },
    {
      ...
      mapQuery: "Moore Street Market",
      icon: "🚨",
      tasks: [
        { id: 28, text: "10:00 - Moore Street Market (historia de 1916 + fruta barata)" },
        { id: 29, text: "11:00 - Ver Ha'penny Bridge y Millennium Bridge" },
        { id: 30, text: "⚠️ 12:00 - COMPRA OBLIGATORIA en Tesco/M&S (Henry St)" },
    ...
    },
    {
      ...
      mapQuery: "Samuel Beckett Bridge",
      icon: "🏙️",
      tasks: [
        ...
        { id: 40, text: "Ver: Samuel Beckett Bridge (forma de arpa)" },
        { id: 41, text: "Famine Memorial (esculturas conmovedoras)" },
        { id: 42, text: "Estudios de U2 (Windmill Lane)" },
    ...
    },
    {
      ...
      mapQuery: "Howth Cliff Walk",
      icon: "⛰️",
      tasks: [
        { id: 44, text: "10:30 - Caminar a Connolly Station (10 min desde hostel)" },
        { id: 45, text: "Tomar tren DART dirección Howth (siéntate a la IZQUIERDA)" },
        { id: 46, text: "11:15 - Llegar a Howth" },
        { id: 47, text: "🥾 Cliff Path Walk - Ruta Verde (1.5-2h, IMPRESCINDIBLE)" },
        { id: 48, text: "Vistas: Bahía de Dublín, Ireland's Eye island, acantilados" },
        { id: 49, text: "14:00 - COMIDA: Fish & Chips en Beshoffs o Leo Burdock's" },
    ...
    },
    {
      ...
      mapQuery: "National Museum of Ireland - Archaeology",
      icon: "🎫",
      tasks: [
        { id: 52, text: "10:00 - Tomar bus turístico en O'Connell St (€25-30)" },
        { id: 53, text: "Vuelta completa para ver: Kilmainham Gaol, Catedrales" },
        { id: 54, text: "12:00 - Bajar en Kildare St" },
        { id: 55, text: "Museo Nacional de Arqueología (GRATIS - Oros celtas)" },
        { id: 56, text: "14:00 - Almuerzo en zona Merrion Square" },
        { id: 57, text: "OPCIONAL: Bray en tren DART (45 min) - Paseo marítimo" },
        { id: 58, text: "20:00 - CENA DESPEDIDA: The Confession Box (Marlborough St)" },
    ...
    },
    {
      ...
      mapQuery: "Dublin Airport",
      icon: "🛫",
      tasks: [
        { id: 61, text: "04:00 - Despertarse (múltiples alarmas)" },
        { id: 62, text: "04:15 - Check-out Clink i Lár" },
        { id: 63, text: "04:20 - Caminar 3 min a parada Aircoach (frente a Gresham Hotel)" },
        { id: 64, text: "04:30 - Tomar Aircoach 700 (servicio 24h, cada 15 min)" },
        { id: 65, text: "05:00 - Llegada a Dublin Airport (Terminal 1)" },
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <div className="flex items-center gap-4 mt-2 text-sm text-gray-600">
                      ...
                      <a
                        href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(day.mapQuery || day.location)}`}
                        target="_blank"
              ...
              {expandedDay === index && (
                <div className="p-6 pt-0 border-t">
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-blue-600 hover:text-blue-800 my-4 font-medium p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors w-full justify-center"
                  >
                    <MapPin size={18} />
                  ...
                  <div className="space-y-2">
                    {day.tasks.map((task) => (
                      <div key={task.id} className="p-3 rounded hover:bg-gray-50 transition-colors">
                        ...
                        <a 
                          href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(task.text.replace(/^\d{2}:\d{2}\s*-?\s*/, '').replace(/[\u{1F300}-\u{1F9FF}]/gu, ''))}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="ml-8 text-xs text-blue-500 hover:text-blue-700 hover:underline flex items-center gap-1 mt-1 w-fit"
                        >
                          <MapPin size={12} />
                          Ver en mapa
                        </a>
